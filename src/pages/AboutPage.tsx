...
import { Users, Building, Award, Clock, Target, Eye, Heart, Zap, Shield, Globe2 } from "lucide-react";
...
const AboutPage = () => {
  ...
  const values = [
    {
      icon: Target,
      title: "Excellence",
      description: "We deliver superior quality products and services that exceed expectations."
    },
    {
      icon: Shield,
      title: "Reliability", 
      description: "Dependable solutions and support you can count on for your business operations."
    },
    {
      icon: Heart,
    ...
    },
    {
      icon: Zap,
      title: "Innovation",
      description: "Embracing cutting-edge technology to provide modern solutions for evolving needs."
    },
    {
      icon: Eye,
      title: "Transparency",
      description: "Clear communication and honest business practices in all our interactions."
    },
    {
      icon: Globe2,
      title: "Integrity",
      description: "Ethical business practices and genuine commitment to our clients' success."
    }
  ];
  ...
  const milestones = [
    { 
      year: "2008", 
      title: "Foundation", 
      description: "WSN established as a pioneer in office equipment distribution",
      highlight: true
    },
    { 
      year: "2012", 
      title: "Sector Expansion", 
      description: "Strategic expansion into oil & gas and banking sectors"
    },
    { 
      year: "2016", 
      title: "Digital Evolution", 
      description: "Integration of IT solutions and digital transformation services"
    },
    { 
      year: "2020", 
      title: "Market Leadership", 
      description: "Achieved recognition as a leading distributor nationwide"
    },
    { 
      year: "2024", 
      title: "Future Forward", 
      description: "Pioneering next-generation office automation solutions",
      highlight: true
    }
  ];
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl mx-auto text-center text-white">
            ...
            <p className="text-xl md:text-2xl text-blue-100 mb-12 leading-relaxed max-w-3xl mx-auto">
              For over 15 years, we've been transforming workspaces across Nigeria with 
            ...
            <div className="grid lg:grid-cols-2 gap-16 items-center">
              <div>
                ...
                <div className="space-y-6 text-lg text-gray-600 leading-relaxed">
                  <p>
                    Founded in 2008, Wellstocked Nigeria Limited emerged from a vision to 
                    revolutionize office automation across Nigeria. What started as a mission 
                    to provide quality equipment has evolved into a comprehensive technology 
                    partnership platform.
                  </p>
                  <p>
                    Today, we stand as Nigeria's premier office automation specialist, 
                    serving over 500 clients across diverse industries including oil & gas, 
                    banking, telecommunications, and government sectors.
                  </p>
                  <p>
                    Our commitment to excellence, innovation, and customer success has made us 
                    the trusted choice for organizations seeking to transform their operations 
                    through technology.
                  </p>
                </div>
              </div>
